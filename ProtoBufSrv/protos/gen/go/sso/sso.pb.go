...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	ApdId    int32  `protobuf:"varint,3,opt,name=apd_id,json=apdId,proto3" json:"apd_id,omitempty"` // ID of the application to login to
}
...
func (x *LoginRequest) GetApdId() int32 {
	if x != nil {
		return x.ApdId
	}
	return 0
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token for the logged user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x70, 0x64,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x64, 0x49, 0x64,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x04, 0x4c, 0x6f, 0x67, 0x6e, 0x12, 0x12, 0x2e, 0x61,
	...
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x16, 0x5a,
	0x14, 0x61, 0x73, 0x75, 0x62, 0x62, 0x6f, 0x74, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
